...
const QUICK_ACTIONS = [
  { key: "add_student", label: "Add Student", icon: UserPlus, type: "nav", href: "/dashboard/admissions" },
  ...
  { key: "create_subject", label: "Create Subject", icon: BookOpen, type: "nav", href: "/dashboard/academics" },
  { key: "publish_notice", label: "Publish Notice", icon: Megaphone, type: "modal" },
  { key: "collect_fee", label: "Collect Fee", icon: Wallet, type: "nav", href: "/dashboard/finance" },
  { key: "generate_report", label: "Generate Report", icon: FileBarChart, type: "nav", href: "/dashboard/reports" },
];
