    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="space-y-2">
        ...
        <ReportCard
          ...
          action={() => router.push("/dashboard/academics/examinations")}
        />
      </div>
      ...
      <div className="space-y-2">
        <ReportCard
          ...
          action={() => router.push("/dashboard/attendance/student-register")}
        />
        <ReportCard
          ...
          action={() => router.push("/dashboard/attendance/staff-report")}
        />
      </div>
